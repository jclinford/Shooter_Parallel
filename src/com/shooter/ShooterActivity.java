...
public class ShooterActivity extends SimpleBaseGameActivity
{
	...
	public TiledTextureRegion meteor1TextureRegion;	// ship3.png
	public TiledTextureRegion meteor2TextureRegion;	// ship3.png
	public TiledTextureRegion meteor3TextureRegion;	// ship3.png
	...
	private AndEngineWorld physicsWorld;
	private Scene scene;
	...
	public void onCreateResources() 
	{
		...
		meteor1TextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(bitmapTextureAtlas, this, "meteor1.png", 0, 553, 1, 1); //36 x 33
		meteor2TextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(bitmapTextureAtlas, this, "meteor2.png", 0, 586, 1, 1); //34 x 23
		meteor3TextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(bitmapTextureAtlas, this, "meteor3.png", 0, 609, 1, 1); //45 x 45
		explosionTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(bitmapTextureAtlas, this, "explosion.png", 0, 654, 1, 12);	// 36 x something
	...
	{		
		...
		hasBoss = false;
		level = 1;
		physicsWorld = new AndEngineWorld(CAMERA_WIDTH, CAMERA_HEIGHT);
	...
	public AndEngineWorld getPhysicsWorld()
	{
		return physicsWorld;
	}
